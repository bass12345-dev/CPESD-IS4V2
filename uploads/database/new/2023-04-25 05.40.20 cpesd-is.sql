...
-- Date: Tue, 25 Apr 2023 05:40:20 +0000
...
SET autocommit=0;
INSERT INTO `cso` VALUES (1,'sdsad','sad','2','Binuangan','Basil','09','213','sadsadsa@asd','PO','active','','','','','2023-04-18 06:16:40'),(4,'123','21321','2','Villaflor','qwqwqwe','09','312312','asdsadas@aSASDASDSAD','PO','active','','','','','2023-04-16 21:02:31'),(6,'12323','Golden Hands','2','Lower Loboc','qwqwqwe','0922323','312312','as','PO','active','','','','','2023-04-18 06:15:50');
/*!40000 ALTER TABLE `cso` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `cso` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `cso_officers` VALUES (24,1,'President/BOD Chairperson/BOT-1',2,'asdasd','sd','sdsd','sd','0923324','sdfdsfsdf@sdfsdf','2023-04-16 21:21:32'),(25,2,'Vice President/BOD Vice Chairperson-2',2,'sad','sda','dsad','sd','09','asdasd@asdsad','2023-04-16 22:22:42'),(26,3,'Secretary-3',2,'asdsad','asd','asdasd','as','092321','asdasda@asdasd','2023-04-16 22:22:53'),(27,4,'Treasurer-4',2,'sadsa','sadasd','','','09','sadasd@asdasd','2023-04-16 22:23:03'),(28,5,'Auditor-5',2,'asdsad','sadas','asdsad','asdsad','092132','dasdas@asdasd','2023-04-16 22:23:13'),(31,1,'President/BOD Chairperson/BOT-1',3,'asdsad','sd','dsad','sd','092321','AsaSA@adasdasd','2023-04-17 02:33:02'),(33,2,'Vice President/BOD Vice Chairperson-2',7,'asdsad','sd','dsad','sd','0923','asdsad@asdasd','2023-04-18 06:35:52'),(34,1,'President/BOD Chairperson/BOT-1',7,'asdasd','sda','sdsd','','09','sdfdsfsdf@sdfsdf','2023-04-18 06:52:28'),(35,3,'Secretary-3',7,'asdsad','sd','sdsd','sd','09','asdasd@asdsad','2023-04-18 06:53:27'),(37,1,'President/BOD Chairperson/BOT-1',1,'asdcsad','sds','sd','s','0921321','asdasdasd@asdasdasd','2023-04-23 23:31:16'),(38,2,'Vice President/BOD Vice Chairperson-2',1,'asd','sd','sd','sd','092313','sadsad@asdasdasd','2023-04-23 23:31:30'),(39,3,'Secretary-3',1,'asdsad','213','sad','sadsad','09213213','asdsadas@asdasdasd','2023-04-23 23:31:44'),(40,4,'Treasurer-4',1,'asdasd','sds','sd','sd','09213','asdasd@saasd','2023-04-23 23:31:56'),(41,5,'Auditor-5',1,'sadsad','asasd','sad','asd','09213213','asdasdasd@asdasd','2023-04-23 23:32:06'),(42,6,'Manager-6',1,'asdasd','asd','sad','sad','09213213','asdasd@asdasd','2023-04-23 23:32:13');
/*!40000 ALTER TABLE `cso_officers` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `cso_officers` with 15 row(s)
--
...
SET autocommit=0;
INSERT INTO `project_monitoring` VALUES (2,10,'asdasd','2023-04-24 00:00:00',12,12,12,12,12,12.00,12.00,12.00,12.00,12.00,12.00,12.00),(3,11,'asdsad','2023-04-23 00:00:00',12,12,12,12,12,12.00,12.00,12.00,12.00,12.00,12.00,12.00),(4,12,'asdsadasd','2023-04-24 00:00:00',12,1,12,12,12,12.00,12.00,12.00,12.00,12.00,12.00,12.00),(5,13,'asasdsad','2023-04-23 00:00:00',12,12,12,12,12,12.00,12.00,12.00,12.00,12.00,12.00,12.00);
/*!40000 ALTER TABLE `project_monitoring` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `project_monitoring` with 4 row(s)
--
...
SET autocommit=0;
INSERT INTO `responsibility_center` VALUES (2,'21321','basil','2023-04-07 15:14:08');
/*!40000 ALTER TABLE `responsibility_center` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `responsibility_center` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `responsible_section` VALUES (1,'asdsad','2023-04-07 15:48:41'),(5,'asdasdasdssadasd','2023-04-22 08:55:16'),(6,'asdsadsadasd','2023-04-22 08:55:18'),(7,'sadsad','2023-04-22 11:12:37');
...
CREATE TABLE `rfa_clients` (
  ...
  `rfa_client_added_by` int(11) NOT NULL,
...
SET autocommit=0;
INSERT INTO `rfa_clients` VALUES (7,9,'Basil John','','Manabo','',3,'Binuangan',9213213,12,'unemployed and actively looking for work','2023-04-24 06:08:25'),(8,9,'sad','sad','sad','sad',2,'Dullan Sur',92323,2,'employed','2023-04-25 04:38:32');
/*!40000 ALTER TABLE `rfa_clients` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `rfa_clients` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `rfa_transactions` VALUES (25,'893228040202304241',8,9,1,'simple',1,'pending','2023-04-24 06:18:19');
...
CREATE TABLE `rfa_transaction_history` (
  ...
  `rfa_tracking_status` enum('received','for-approval','completed') NOT NULL,
...
SET autocommit=0;
INSERT INTO `trainings` VALUES (12,10,'aasdasd',12,1,'121','asdasd','0000-00-00 00:00:00'),(13,14,'sdfsdf',23,23,'21321','sadasdasdasd','0000-00-00 00:00:00');
...
SET autocommit=0;
INSERT INTO `transactions` VALUES (10,9,1,'2023-04-23 20:50:31',6,4,0,2,'2023-04-23 13:50:30',4,1,0,'','completed',NULL),(11,9,2,'2023-04-23 21:02:49',6,4,0,2,'2023-04-23 14:02:31',4,1,0,'','completed',NULL),(12,9,3,'2023-04-23 23:20:10',7,4,0,2,'2023-04-23 16:19:54',6,1,0,'','completed',NULL),(13,9,4,'2023-04-23 23:21:20',7,4,0,2,'2018-05-16 00:31:00',6,1,0,'','completed',NULL),(14,9,5,'2023-04-24 04:03:41',7,5,11,2,'2023-04-23 21:03:33',4,0,1,'','pending',NULL);
...
SET autocommit=0;
INSERT INTO `type_of_activities` VALUES (2,'Job Vacancy Solicitation','2023-04-11 01:19:20'),(3,'Regular Monthly COOP Visit','2023-04-11 01:19:33'),(4,'Regular Monthly Project Monitoring','2023-04-11 01:19:45'),(5,'Training','2023-04-11 01:19:52');
/*!40000 ALTER TABLE `type_of_activities` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `type_of_activities` with 4 row(s)
--
...
SET autocommit=0;
INSERT INTO `type_of_request` VALUES (1,'sdasdasd','2023-04-19 07:38:03'),(2,'assadsad','2023-04-19 07:38:09'),(3,'asdsad','2023-04-19 07:43:39'),(4,'asdsad','2023-04-19 07:44:01'),(5,'asdasdasdas','2023-04-19 07:44:04'),(6,'sdasdasd','2023-04-19 15:45:58');
/*!40000 ALTER TABLE `type_of_request` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `type_of_request` with 6 row(s)
--
...
SET autocommit=0;
INSERT INTO `under_type_of_activity` VALUES (2,1,'sample','2023-04-07 16:54:18'),(11,5,'asdsadsadsssdsd','2023-04-22 08:41:13');
/*!40000 ALTER TABLE `under_type_of_activity` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `under_type_of_activity` with 2 row(s)
--
...
-- Dump completed on: Tue, 25 Apr 2023 05:40:21 +0000
