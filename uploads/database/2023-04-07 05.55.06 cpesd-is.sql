...
-- Date: Fri, 07 Apr 2023 17:55:06 +0000
...
SET autocommit=0;
INSERT INTO `cso` VALUES (1,'sdsad','sad','2','tuyabang bajo','Basil','09','213','sadsadsa@asd','po','active','','','','','2023-04-07 05:42:03'),(2,'1212','Basil','2','tuyabang bajo','','09','','','coop','active','','','','','2023-04-07 05:46:48'),(3,'12122','213','2','Tuyabang Bajo','','09','','','po','active','','','','','2023-04-07 15:12:41'),(4,'123','21321','2','Tuyabang Bajo','','09','','','coop','active','','','','','2023-04-07 15:13:24');
...
SET autocommit=0;
INSERT INTO `type_of_activities` VALUES (1,'asdsad','2023-04-07 16:34:00');
/*!40000 ALTER TABLE `type_of_activities` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `type_of_activities` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `under_type_of_activity` VALUES (2,1,'sample','2023-04-07 16:54:18'),(3,1,'asdsad','2023-04-07 16:55:47'),(4,1,'asd','2023-04-07 16:55:53');
/*!40000 ALTER TABLE `under_type_of_activity` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `under_type_of_activity` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `users` VALUES (2,'Sample','','sample','','','','','user','active','useruser','user','2023-04-06 14:03:07'),(8,'Mark','','Artigas',NULL,'','',NULL,'admin','active','markuser','$2y$10$aoGcqKLQajPTRZMHK9veKuj2RM5YOAum6ZQjlkPUW.Z54ZH/wq2va','2023-04-06 16:32:32'),(9,'Basil John','C.','Manabo',NULL,'','',NULL,'user','active','basiluser','$2y$10$9/ESqpwWBUnryLu3QtGE5OK3qNrA/nvSTp42sOH650.fNNbeyXYMu','2023-04-07 03:04:02');
...
-- Dump completed on: Fri, 07 Apr 2023 17:55:06 +0000
