...
var res_center_table = $('#responsibility_table').DataTable({
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return '<ul class="d-flex justify-content-center">\
                                <li class="mr-3 "><a href="javascript:;" class="text-secondary action-icon" data-id="'+data['responsibility_center_id']+'" data-name="'+data['responsibility_center_name']+'" data-code="'+data['responsibility_center_code']+'" id="update-center" data-toggle="modal" data-target="#update_center_modal"><i class="fa fa-edit"></i></a></li>\
                                <li><a href="javascript:;" data-id="'+data['responsibility_center_id']+'" data-name="'+data['responsibility_center_name']+'"  id="delete-center"  class="text-danger action-icon"><i class="ti-trash"></i></a></li>\
                                </ul>';
                }
 ...
 $('#update_center_form').on('submit', function(e) {
    ...
    $.ajax({
            type: "POST",
            url: base_url + 'api/update-center',
            data: $(this).serialize(),
            dataType: 'json',
            beforeSend: function() {
    ...
    $.ajax({
      ...
      $(document).on('click','a#delete-center',function (e) {
        ...
        if (result.value) {
                    ...
                    $.ajax({
                            type: "POST",
                            url: base_url + 'api/delete-center',
                            data: {id:id},
                            cache: false,
                            dataType: 'json', 
                            beforeSend : function(){
