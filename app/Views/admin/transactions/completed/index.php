   ...
   $.ajax({
      ...
      success: function (data) {
         ...
         for (var i = 0; i < data.length; i++) {
            total_volume_of_business = total_volume_of_business + parseFloat(data[i].total_volume_of_business);
         }
         $('.all_total_volume_of_business').text('₱ ' + parseFloat(total_volume_of_business).toFixed(2));
         for (var i = 0; i < data.length; i++) {
            total_cash_position = total_cash_position + parseFloat(data[i].total_cash_position);
         }
