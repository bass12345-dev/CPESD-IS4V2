...
$('#update_oldpassword_form').on('submit', function(e) {
        e.preventDefault();

         $.ajax({
            type: "POST",
            url: base_url + 'api/verify-old-password',
            data : $(this).serialize(),
            cache: false,
           
            dataType: 'json',
            beforeSend: function() {
                $('.btn-old-password').text('Please wait...');
                $('.btn-old-password').attr('disabled','disabled');
            },
             success: function(data)
            {  

                if (data.response) {
                    $('#old_password_modal').modal('hide')
                    $('.btn-old-password').text('Submit');
                    $('.btn-old-password').removeAttr('disabled');
...
$('#update_password_form').on('submit', function(e) {
   ...
   const confirm_password = $('input[name=confirm_password]').val();
        ...
        Swal.fire({
         ...
         $.ajax({
            ...
            dataType: 'json',
            beforeSend: function() {
                $('.btn-update-password').text('Please wait...');
            ...
            {  
                ...
                if (data.response) {
                    ...
                    $('.btn-update-password').text('Submit');
   ...
   Swal.fire({
        ...
        if (result.value) {
            ...
            window.location.href = base_url + 'api/auth/sign_out';
...
$('#update_information_form').on('submit', function(e) {
        e.preventDefault();
         ...
         $.ajax({
            type: "POST",
            url: base_url + 'api/update-user-information',
            ...
            dataType: 'json',
            beforeSend: function() {
                $('.btn-update-info').text('Please wait...');
                $('.btn-update-info').attr('disabled','disabled');
            },
             success: function(data)
            {            
                if (data.response) {
