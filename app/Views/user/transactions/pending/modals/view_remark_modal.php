<div class="modal fade" id="view_remarks_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            <button type="submit" class="btn  btn-update-center sub-button" id="btn-done-remarks" name="btn-done-remarks " >Done</button>
         </div>
      </div>
   </div>
</div>